...
namespace CS82ANGULAR.Commands
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class CrtJavaScriptsCommand
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CrtJavaScriptsCommand"/> class.
        /// Adds our command handlers for menu (commands must exist in the command table file)
        /// </summary>
        /// <param name="package">Owner package, not null.</param>
        /// <param name="commandService">Command service to add command to, not null.</param>
        private CrtJavaScriptsCommand(AsyncPackage package, OleMenuCommandService commandService)
        {
        ...
        /// </summary>
        public static CrtJavaScriptsCommand Instance
        {
            get;
            private set;
        }
        ...
        {
            // Switch to the main thread - the call to AddCommand in CrtJavaScriptsCommand's constructor requires
            // the UI thread.
            await ThreadHelper.JoinableTaskFactory.SwitchToMainThreadAsync(package.DisposalToken);

            OleMenuCommandService commandService = await package.GetServiceAsync(typeof(IMenuCommandService)) as OleMenuCommandService;
            Instance = new CrtJavaScriptsCommand(package, commandService);
        ...
        private void Execute(object sender, EventArgs e)
        {
            ...
            MainWindowJavaScripts dataContext = new MainWindowJavaScripts(dTE2, TextTemplating, DialogFactory);
